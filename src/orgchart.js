        ...
        if ("svg" == o.ext)
          if (l) l(o, r.innerHTML)
            ...
            if (
              ...
              !1 === (n = OrgChart.events.publish("exportend", [s, a])))
            )
              return !1
          }
        else
              ...
              l
                ...
                : ((e = JSON.stringify(e)),
                  OrgChart._ajax(
                    ...
                    "arraybuffer",
                    function (t) {
                      if (!1 === OrgChart.events.publish("exportend", [s, t]))
                        return !1
                      OrgChart.loading.hide(s),
                        OrgChart._downloadFile(
                          o.mime,
                          t,
                          o.filename,
...
;(OrgChart.prototype._mouseDownHandler = function (t, e, r) {
  ...
  (OrgChart.searchUI.prototype.addSearchControl = function () {
    ...
    ;(t.innerHTML = OrgChart.searchUI.createSearchIcon(
  ...
  (OrgChart.server._initNode = function (t, e, r, i, a, n, o, l, s, h, d) {
    ...
    0 < u && (t.subLevels = u),
      -1 != t.tags.indexOf("assistant") && (t.isAssistant = !0)
  }),
  ...
  (OrgChart.server._createNodes = function (a, t, e, r, i, n) {
    for (var o = a.nodes, l = {}, s = [], h = [], d = 0; d < o.length; d++) {
      ...
      null != c.ppid && (f.ppid = c.ppid),
        c.stpid && (f.stpid = c.stpid),
        null != a.orderBy &&
          (f.order = OrgChart.server._getOrderFieldValue(c, a.orderBy)),
        (l[c.id] = f),
        s.push(c.id)
    }
    null != a.orderBy &&
    ...
    for (d = 0; d < E.length; d++) {
      ...
      for (w = 0; w < f.children.length; w++) {
        ;(U = f.children[w]).isAssistant ||
          (-1 != U.tags.indexOf("right-partner")
            ? ((U.isPartner = 1), (U.children = []), M.push(U.id))
            : -1 != U.tags.indexOf("left-partner")
            ? ((U.isPartner = 2), (U.children = []), N.push(U.id))
            : -1 == U.tags.indexOf("partner") || B % 2
            ? -1 != U.tags.indexOf("partner") && B % 2
              ? ((U.isPartner = 2), (U.children = []), N.push(U.id), B++)
              : null != U.ppid
              ? (T[U.ppid] || (T[U.ppid] = []), T[U.ppid].push(U.id))
              : L.push(U.id)
            : ((U.isPartner = 1), (U.children = []), M.push(U.id), B++))
      }
      f.children = []
      ...
      for (w = N.length - 1; 0 <= w; w--)
        if (T[N[w]])
          for (var R = 0; R < T[N[w]].length; R++)
            f.children.push(l[T[N[w]][R]]),
              P++,
      ...
      for (w = 0; w < M.length; w++)
        if (T[M[w]])
          for (R = 0; R < T[M[w]].length; R++)
            f.children.push(l[T[M[w]][R]]),
              F++,
      ...
      if (
        ...
        for (w = 0; w < f.subLevels; w++) {
          ...
          if ((OrgChart.server._initDinamicNode(j, f.lcn), (y = f.parent))) {
            var D = y.children.indexOf(f)
            ;-1 < D && (y.children.splice(D, 1), y.children.splice(D, 0, j)),
              j.children.push(f),
              (j.parent = y),
              (f.parent = j),
              (l[j.id] = j)
    ...
    for (var Y in S) {
      ...
      for (w = y.children.length - 1; 0 <= w; w--) {
        ;(U = y.children[w]).isAssistant
          ? ((U.parent = null), y.children.splice(w, 1), X.splice(0, 0, U.id))
          : U.isPartner ||
            ((U.parent = j).children.unshift(U), y.children.splice(w, 1))
      }
      if (X.length % 2) {
          ...
          if (
            ...
            for (d = it.length - 1; 0 <= d; d--) {
              if (
                ...
                for (w = y.children.length - 1; 0 <= w; w--)
                  U.id == y.children[w].id && y.children.splice(w, 1)
                var at = l[it[d - 1]]
                ;(U.parent = at),
                  (U.layout = OrgChart.mixed),
                  at.children.push(U)
            ...
            OrgChart.server._initDinamicNode(j, y.lcn),
              ((l[j.id] = j).layout = OrgChart.tree)
            var nt = []
            for (d = rt.childrenIds.length - 1; 0 <= d; d--) {
              for (U = l[rt.childrenIds[d]], w = 0; w < y.children.length; w++)
                y.children[w].id == U.id && y.children.splice(w, 1)
              if (
                ((U.parent = null),
                (U.layout = OrgChart.tree),
                rt.layout == OrgChart.treeRightOffset && nt.splice(0, 0, U.id),
                rt.layout == OrgChart.treeLeftOffset ||
                  rt.layout == OrgChart.treeRightOffset)
              ) {
                var ot = new OrgChart.node(U.id + "_mirror", null, [], "mirror")
                OrgChart.server._initDinamicNode(ot, U.lcn),
  ...
  (OrgChart.server._getResponse = function (
    ...
    if (
      ...
      (C.maxY = n),
      (C.minY = l),
      null != s || f || i.align != OrgChart.CENTER)
    ) {
      ...
      !(function (t, i, e) {
        ...
        t.addEventListener(
          ...
          function (t) {
            ...
            var r =
              parseFloat(o.innerBar.clientWidth) - parseFloat(o.bar.clientWidth)
